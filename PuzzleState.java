...
public class PuzzleState implements Comparable<PuzzleState>
{
	...
	public direction[] getPossibleActions()
	{
		...
		{
			System.out.println("There was an error in processing! Aborting... IMPOSSI");
			System.exit(1);
		}
			...
			blankLocation = findBlankCell();
				...
				else
				{
					result++;
                                ...
                                // Checking the Height value aswell
                                // needed to handle NxM puzzles
	...
	public ArrayList<PuzzleState> explore()
	{
		...
		for(int i = 0; i < possibleMoves.length; i++)
		{
			...
			{
				System.out.println("There was an error in processing! Aborting... explore");
				System.exit(1);
			}
		}	
		return Children;
